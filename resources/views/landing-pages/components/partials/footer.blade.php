<footer>
    <div class="bg-secondary inner-box ">
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                   <x-logo src="{{ asset('storage/images/logo1.png') }}" title="Auctra" style="color: #ffffff; font-weight: 600;" href="{{ route('landing-pages.index') }}" />
            ...
            <div class="row">
                <div class="col-md-12 text-center text-white">
                    <p class="mb-0">©
                        ...
                        </script>  Auctra, All Rights Reserved.
                    </p>
                </div>
            </div>
        </div>
